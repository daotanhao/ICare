...
import com.icare.adapter.StepViewPagerAdapter;
    ...
    private void addEvents() {
        ...
        imgSettingStepGoal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(StepActivity.this);
                ...
                if ("empty".equals(step_goal)) {
                    ...
                    docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(StepActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    });
                }
            }
